...
$products = getProductsByGender($allProducts, "mens");
...
$categories = [
  ["title" => "Everyday", "image" => "https://www.allbirds.com/cdn/shop/files/26Q2_CanvasCruiser_Site_Homepage_CategoryRow-01_Desktop-Mobile_2x3_01_Lifestyle.jpg?v=1774909856&width=1024", "href" => "#", "cta" => "Shop Everyday"],
  ["title" => "Running", "image" => "https://www.allbirds.com/cdn/shop/files/26Q2_CanvasCruiser_Site_Homepage_CategoryRow-01_Desktop-Mobile_2x3_04_Lifestyle.jpg?v=1774909855&width=1024", "href" => "#", "cta" => "Shop Running"],
...
<html lang="en">
  ...
  <body>
    ...
    <main class="collection-page">
      ...
      <section class="collection-grid" aria-label="Men's new arrivals">
      ...
      <?php $infoTitle = "MEN'S SHOES"; $infoDesc = "Crafted from premium natural materials, our men's shoes deliver all-day comfort without compromising on style. From everyday sneakers to performance runners, each pair is designed to feel as good as it looks."; ?>
